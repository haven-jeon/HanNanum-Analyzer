 ...
 *
 */
public class KoNLPHMMTagger implements PosTagger {
	/**
	...
	public void initialize(String baseDir, String configFile) throws Exception  {
		...
		pwt_pos_tf = new ZipProbabilityDBM(baseDir, json.getValue("pwt.pos"));
		ptt_wp_tf = new ZipProbabilityDBM(baseDir, json.getValue("ptt.pos"));
		ptt_pos_tf = new ZipProbabilityDBM(baseDir, json.getValue("ptt.wp"));
	}
